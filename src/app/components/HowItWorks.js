  ...
  const steps = [
    {
      ...
      description:
        "Tell us who you are, what you offer, the client's name, and the project type. Takes less than 60 seconds.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Copy your favorite version with one click. Save it to your history or regenerate in seconds. Then send — and win.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 className="text-4xl font-bold text-[#F4F4F5] mt-4">
            From Brief to <span className="gradient-text">Send-Ready</span> in 3
            Steps
          </h2>
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#F4F4F5] mb-3">
                  {step.title}
                </h3>
