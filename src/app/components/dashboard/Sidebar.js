...
const navLinks = [
  ...
  { href: '/dashboard/templates',  label: 'Templates',  icon: Library,         id: 'sidebar-templates' },
  ...
  { href: '/dashboard/help',       label: 'Help',       icon: HelpCircle,      id: 'sidebar-help' },
]
            ...
            {!sidebarCollapsed && (
              ...
              >
                <div className="flex items-center gap-1.5">
                  <p className="text-sm font-semibold text-[#F4F4F5] truncate">{mockUser.name}</p>
                  {mockUser.plan === 'free' && (
                    <span className="badge badge-amber text-[9px] px-1.5 py-0.5 flex-shrink-0">Free</span>
                  )}
                  {mockUser.plan === 'pro' && (
                    <span className="badge badge-violet text-[9px] px-1.5 py-0.5 flex-shrink-0 flex items-center gap-1">
                      <Crown size={8} />Pro
                    </span>
                  )}
                </div>
                <p className="text-xs text-[#52525B] truncate">{mockUser.email}</p>
              </motion.div>
            )}
          </AnimatePresence>
