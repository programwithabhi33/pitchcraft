...
function OrDivider() {
  return (
    <div className="flex items-center gap-3 my-1">
      ...
      <span className="text-xs text-[#52525B] font-medium tracking-wider">
    ...
    <div className="min-h-screen flex bg-[#09090B]">
        ...
        <div className="relative flex flex-col flex-1 p-10 justify-between">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-[#A1A1AA] text-sm leading-relaxed">
                Fill in 4 fields. Get a polished cold email, a 1-page proposal
                PDF, and a 3-email follow-up sequence — in under 30 seconds.
              </p>
            </div>
          ...
          >
            ...
            <p className="text-xs text-[#71717A] leading-snug">
              Join <span className="text-[#F4F4F5] font-semibold">2,400+</span>{" "}
              freelancers
              <br />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:py-0">
        ...
        >
          ...
          <span className="text-[#F4F4F5] font-bold text-lg">
            PitchCraft <span className="gradient-text">AI</span>
          </span>
        </Link>
        ...
        >
          ...
          <p className="text-center text-xs text-[#52525B] mt-5 leading-relaxed">
            ...
            <a
              ...
              className="text-[#71717A] hover:text-[#A1A1AA] transition-colors underline underline-offset-2"
            >
              Terms of Service
            </a>{" "}
            and{" "}
