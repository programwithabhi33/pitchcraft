...
function FloatingInput({
  ...
  return (
    <div className="relative">
      <div
        className={`relative flex items-center rounded-xl border transition-all duration-200 bg-[#09090B] ${error
      ...
      >
        ...
        <label
          htmlFor={id}
          className={`pointer-events-none absolute left-11 transition-all duration-200 font-medium select-none ${focused || hasValue
...
function GoogleButton({ label }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="group w-full flex items-center justify-center gap-3 rounded-xl border border-[#3F3F46] bg-[#18181B] hover:bg-[#27272A] hover:border-[#52525B] text-[#F4F4F5] font-semibold text-sm py-3.5 transition-all duration-200 active:scale-[0.99] cursor-pointer disabled:opacity-50"
    >
      {loading ? (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
      ...
      {error && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="bg-rose-500/10 border border-rose-500/20 text-rose-500 text-xs p-3 rounded-xl flex items-center gap-2"
        >
          <AlertCircle size={14} />
          {error}
        </motion.div>
      ...
      <div className="flex items-center justify-between pt-1">
        <div className="flex items-center gap-2.5">
          <Checkbox.Root
            ...
            className="w-4 h-4 rounded border border-[#3F3F46] bg-[#09090B] data-[state=checked]:bg-[#7C3AED] data-[state=checked]:border-[#7C3AED] flex items-center justify-center transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/40 cursor-pointer"
          >
            <Checkbox.Indicator>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
      ...
      <div className="flex items-start gap-2.5 pt-1">
        <Checkbox.Root
          ...
          checked={checked}
          onCheckedChange={setChecked}
          className="mt-0.5 w-4 h-4 rounded border border-[#3F3F46] bg-[#09090B] data-[state=checked]:bg-[#7C3AED] data-[state=checked]:border-[#7C3AED] flex items-center justify-center transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/40 flex-shrink-0 cursor-pointer"
        >
          <Checkbox.Indicator>
            <CheckIcon className="w-2.5 h-2.5 text-white" strokeWidth={3} />
          </Checkbox.Indicator>
        ...
        >
          I agree to the{' '}
          <a href="/terms" id="terms-link" className="text-[#7C3AED] hover:text-[#A78BFA] transition-colors">Terms of Service</a>
          {' '}and{' '}
          <a href="/privacy" id="privacy-link" className="text-[#7C3AED] hover:text-[#A78BFA] transition-colors">Privacy Policy</a>
        </Label.Root>
      </div>
      ...
      <div className="hidden lg:flex lg:w-[42%] relative overflow-hidden flex-col">
        ...
        <div className="relative flex flex-col flex-1 p-10 justify-between">
          ...
          <div className="mb-4 w-full max-w-xs">
            <Link href="/" className="flex items-center gap-2 text-[#A1A1AA] hover:text-[#F4F4F5] transition-colors">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-[#A1A1AA] text-sm leading-relaxed">
                Fill in 4 fields. Get a polished cold email
                in under 30 seconds.
              </p>
            </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:py-0">
        ...
        >
                ...
                >
                  {[
                    ...
                    <Tabs.Trigger
                      ...
                      value={tab.value}
                      id={tab.id}
                      className="relative flex-1 py-2.5 text-sm font-semibold rounded-lg transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED]/60 data-[state=active]:text-[#F4F4F5] data-[state=inactive]:text-[#71717A] data-[state=inactive]:hover:text-[#A1A1AA] cursor-pointer"
                    >
                      {/* Active indicator */}
                      {activeTab === tab.value && (
                        <motion.div
                ...
                >
                  ...
                  <p className="text-sm text-[#71717A] mt-1">
                    {activeTab === 'login'
                      ...
                      : 'Start writing better emails in 30 seconds'}
                  </p>
                </motion.div>
              </AnimatePresence>
          ...
          <p className="text-center text-xs text-[#52525B] mt-5 leading-relaxed">
            ...
            <a href="/terms" id="auth-footer-terms" className="text-[#71717A] hover:text-[#A1A1AA] transition-colors underline underline-offset-2">Terms of Service</a>
            {' '}and{' '}
            <a href="/privacy" id="auth-footer-privacy" className="text-[#71717A] hover:text-[#A1A1AA] transition-colors underline underline-offset-2">Privacy Policy</a>.
          </p>
        </motion.div>
      </div>
    </div>
